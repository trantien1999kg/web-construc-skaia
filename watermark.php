...
if($_GET['w'] <= 400){
	if(! defined('WATERMARK_OVERLAY_IMAGE') ) define ('WATERMARK_OVERLAY_IMAGE', _upload_hinhanh_l.$row_setting['bgcontent']); // the watermark image
} else {
...
if(! defined('BROWSER_CACHE_MAX_AGE') ) 	define ('BROWSER_CACHE_MAX_AGE', 10);				// Time to cache in the browser
